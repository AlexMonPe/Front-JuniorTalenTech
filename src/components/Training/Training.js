...
export const Training = ({
  ...
  return (
    <Fragment>
      {isEditable ? currProfile.map((training, index) => {
        return (
          <div className="container-form-data mb-5" key={index}>
            ...
            <div className="form-floating mb-4 col-12 col-sm-5">
              <select
                ...
                name="level"
                defaultValue={isEditable ? currProfile[index].level : training.level}
            ...
            <div className="form-floating mb-4 col-12 col-sm-5">
              <input
                ...
                id="specialty"
                name="specialty"
                defaultValue={isEditable ? currProfile[index].specialty : training.specialty}
            ...
            <div className="form-floating mb-4 col-12 col-sm-11">
              <div className="form-floating">
                <input
                  ...
                  id="center"
                  name="center"
                  defaultValue={isEditable ? currProfile[index].center : training.center}
                  onChange={(event) => handleTrainingChange(index, event)}
                  required
                />
            ...
            <div className="form-floating mb-4 col-12 col-sm-11 col-md-5 col-lg-5">
              <input
                ...
                placeholder="año"
                name="start_year"
                defaultValue={isEditable ? currProfile[index].start_year : training.start_year}
                pattern="^[0-9]+$"
                minLength={4}
                maxLength={4}
                onChange={(event) => handleTrainingChange(index, event)}
            ...
            <div className="form-floating mb-4 col-12 col-sm-11 col-md-5 col-lg-5">
              <input
                ...
                placeholder="año"
                name="finish_year"
                defaultValue={isEditable ? currProfile[index].finish_year : training.finish_year}
                pattern="^[0-9]+$"
                minLength={4}
                maxLength={4}
                onChange={(event) => handleTrainingChange(index, event)}
